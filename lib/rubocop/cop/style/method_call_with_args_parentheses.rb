...
module RuboCop
  module Cop
    module Style
      ...
      #
      # - Parentheses are required in method calls with arguments inside
      #   literals, logical operators, setting default values in position and
      #   keyword arguments, chaining, and more cases where omitting them is a
      #   syntax error.
      ...
      # - Parentheses are required in anonymous arguments passing, anonymous
      #   keyword passing and anonymous block passing in Ruby 3.2.
      #
